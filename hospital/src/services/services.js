...
servers.getHospitalList = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/hospital/getHospitalList';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};

// 医院详情
servers.getHospital = function (callback) {
  let url = '/doctor/doctorPcPlatform/hospital/getHospital';
...
servers.modifyHospital = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/hospital/modifyHospital';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.modifyDoctorStatus = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/hospital/modifyDoctorStatus';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
// 医护人员资质审核
...
servers.getRole = function (postdata, callback) {
  let url = '/doctor/platform/manager/getRole';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.getRoleList = function (callback) {
  let url = '/doctor/doctorPcPlatform/team/getRoleList';
  servers._get(url, callback);
};

// 角色状态修改
servers.modifyRoleStatus = function (postdata, callback) {
  let url = '/doctor/platform/manager/modifyRoleStatus';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.deleteRole = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/team/modifyTeamMbStatus';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.addRole = function (postdata, callback) {
  let url = '/doctor/platform/manager/addRole';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.modifyRole = function (postdata, callback) {
  let url = '/doctor/platform/manager/modifyRole';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
// 获取权限列表
servers.getFunctionList = function (postdata, callback) {
  let url = '/doctor/platform/manager/getFunctionList';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.teamList = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/team/teamList';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.addTeamMember = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/team/addTeamMember';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
// 查询管理员列表
servers.getManager = function (postdata, callback) {
  let url = '/doctor/platform/manager/getManager';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};

// 获取管理员列表
servers.getManagerList = function (postdata, callback) {
  let url = '/doctor/platform/manager/getManagerList';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.adminLogin = function (postdata, callback) {
  ...
  let url = '/doctor/doctorPcPlatform/login';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
servers.adminLogout = function (callback) {
  let url = '/doctor/doctorPcPlatform/logout';
  servers._get(url, callback);
};
...
// /sso/v1/smsCode/{mobileNo}

servers.sendSmsCode = function (mobileNo, callback) {
  let url = `/sso/v1/smsCode/${mobileNo}`;
  servers._get(url, callback);
}

// /sso/v1/mobile/{mobileNo}/available

servers.checkAvailable = function (mobileNo, callback) {
  let url = `/sso/v1/mobile/${mobileNo}/available`;
  servers._get(url, callback);
}

// /sso/v1/smsCodeVerify

servers.smsCodeVerify = function (postdata, callback) {
  let url = '/sso/v1/smsCodeVerify';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
}

// doctorPcPlatform/regist

servers.regist = function (postdata, callback) {
  let url = '/doctorPcPlatform/regist';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
}
...
servers.resetFn = function (postdata, callback) {
  let url = '/sso/v1/pwdReset';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
}
...
servers.getRoleFunction = function (postdata, callback) {
  let url = '/doctor/platform/manager/getRoleFunction';
  postdata = postdata || {};
  servers._post(url, postdata, callback);
};
...
// 设置角色权限接口
servers.addRoleFunction = function (postdata, callback) {
  let url = '/doctor/doctorPcPlatform/provinces';
  postdata = postdata || {};
  servers._get(url, postdata, callback);
};
...
servers.fetchCities = function (provinces, callback) {
  let url = `/doctor/doctorPcPlatform/${provinces}/cities`;
  servers._get(url, callback);
};
servers.fetchCounties = function (city, callback) {
  let url = `/doctor/doctorPcPlatform/${city}/counties`;
  servers._get(url, callback);
};
servers.fetchTowns = function (counties, callback) {
  let url = `/doctor/doctorPcPlatform/${counties}/towns`;
  servers._get(url, callback);
};
servers.fetchVillages = function (towns, callback) {
  let url = `/doctor/doctorPcPlatform/${towns}/villages`;
  servers._get(url, callback);
};
servers.fetchAddress = function (regionInfo, callback) {
  let url = `/doctor/doctorPcPlatform/regionInfo/${regionInfo}`;
  servers._get(url, callback);
};
